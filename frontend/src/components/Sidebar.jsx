...
import { LayoutDashboard, ShieldCheck, Clock, Plus, ChevronDown, LogOut, Crosshair } from 'lucide-react'
  ...
  return (
    <aside style={S.sidebar}>
      ...
      <div style={S.section}>
        ...
        <NavLink to="/lookalike-scan" style={({isActive}) => ({
          ...S.navItem,
          ...
          <Crosshair size={15} /> Lookalike Scanner
        </NavLink>
      </div>
